...
%แบ่ง data สำหรับ xTrain ตั้งแต่ 1-444 . 80%
xTrain = Xnorm(I(1:444),:);
% แบ่ง data สำหรับ xTest ตั้งแต่ 445-554 20%
xTest = Xnorm(I(445:end),:);
% แบ่ง data สำหรับ tTrain ตั้งแต่ 1-444 80%
tTrain = T(I(1:444),:);
